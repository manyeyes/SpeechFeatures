...
namespace SpeechFeatures.Utils
{
    internal static unsafe class Fftsg
    {
        ...
        internal static void makeipt(int nw, int* ip)
        {
            int j, l, m, m2, p, q;
        ...
        internal static void cftfsub(int n, double* a, int* ip, int nw, double* w)
        {
            if (n > 8)
            {
                if (n > 32)
        ...
        internal static void cftbsub(int n, double* a, int* ip, int nw, double* w)
        {
            if (n > 8)
            {
                if (n > 32)
        ...
        internal static void bitrv216(double* a)
        {
        ...
        internal static void bitrv216neg(double* a)
        {
            double x1r, x1i, x2r, x2i, x3r, x3i, x4r, x4i,
        ...
        internal static void bitrv208(double* a)
        {
        ...
        internal static void bitrv208neg(double* a)
        {
            double x1r, x1i, x2r, x2i, x3r, x3i, x4r, x4i,
        ...
        internal static void cftf1st(int n, double* a, double* w)
        {
        ...
        internal static void cftb1st(int n, double* a, double* w)
        {
            int j, j0, j1, j2, j3, k, m, mh;
            double wn4r, csc1, csc3, wk1r, wk1i, wk3r, wk3i,
                wd1r, wd1i, wd3r, wd3i;
        ...
        internal static void cftrec4(int n, double* a, int nw, double* w)
        {
            int isplt, j, k, m;
        ...
        internal static int cfttree(int n, int j, int k, double* a, int nw, double* w)
        {
            int i, isplt, m;
        ...
        internal static void cftleaf(int n, int isplt, double* a, int nw, double* w)
        {
            if (n == 512)
            {
        ...
        internal static void cftmdl1(int n, double* a, double* w)
        {
            int j, j0, j1, j2, j3, k, m, mh;
        ...
        internal static void cftmdl2(int n, double* a, double* w)
        {
        ...
        internal static void cftfx41(int n, double* a, int nw, double* w)
        {
            if (n == 128)
            {
                cftf161(a, &w[nw - 8]);
        ...
        internal static void cftf161(double* a, double* w)
        {
        ...
        internal static void cftf162(double* a, double* w)
        {
        ...
        internal static void cftf081(double* a, double* w)
        {
        ...
        internal static void cftf082(double* a, double* w)
        {
        ...
        internal static void cftf040(double* a)
        {
            double x0r, x0i, x1r, x1i, x2r, x2i, x3r, x3i;
        ...
        internal static void cftb040(double* a)
        {
            double x0r, x0i, x1r, x1i, x2r, x2i, x3r, x3i;
        ...
        internal static void cftx020(double* a)
        {
            double x0r, x0i;
